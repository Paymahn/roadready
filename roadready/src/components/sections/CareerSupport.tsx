...
const STEP_BENEFITS: Record<number, { description: string; roadreadyShine: string }> = {
  1: {
    ...
    roadreadyShine:
      "We aim to call you back the same working day. A real person, every time — you're not a number. We care about your progression from first call through training and into work, not just closing a sale.",
  },
  2: {
