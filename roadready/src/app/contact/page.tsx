...
export default function ContactPage() {
    ...
    const inputClass = "w-full px-4 py-2.5 bg-slate-950 border border-slate-800 rounded-lg text-dark placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all min-h-[44px]";
                    ...
                    <div className="lg:col-span-3">
                        {submitted ? (
                            ...
                            <form onSubmit={handleSubmit} className="bg-white border border-slate-800 rounded-2xl p-6 sm:p-8 space-y-5 shadow-sm">
                                ...
                                <button type="submit" disabled={loading} className="w-full py-3.5 bg-emerald-600 hover:bg-emerald-500 disabled:opacity-50 disabled:cursor-not-allowed text-white font-semibold rounded-full transition-all duration-200 hover:shadow-lg hover:shadow-emerald-600/25 active:scale-[0.98] min-h-[48px]">
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        <div className="bg-white border border-slate-800 rounded-2xl p-6 shadow-sm">
                            <div className="flex items-center gap-3 mb-3">
                                <div className="w-10 h-10 bg-emerald-600/10 rounded-full flex items-center justify-center">
                            ...
                            <a href="tel:+4401234567890" className="text-xl font-bold text-dark hover:text-emerald-600 transition-colors">01234 567 890</a>
                        </div>
                        ...
                        <div className="bg-white border border-slate-800 rounded-2xl p-6 shadow-sm">
                            <div className="flex items-center gap-3 mb-3">
                                <div className="w-10 h-10 bg-emerald-600/10 rounded-full flex items-center justify-center">
                                    <svg className="w-5 h-5 text-emerald-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                                </div>
                                <div>
